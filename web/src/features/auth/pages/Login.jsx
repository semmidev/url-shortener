...
const perks = [
  { icon: Link2,       text: 'Shorten any long URL into a clean, shareable link' },
  { icon: BarChart3,   text: 'Track clicks, referrers, and device analytics in real time' },
  { icon: ShieldCheck, text: 'Secure, encrypted links with expiry and QR code support' },
]
        ...
        >
          <div className="space-y-3">
            ...
            <h2 className="text-2xl lg:text-3xl font-extrabold tracking-tight leading-snug">
              Manage your short links, all in one place.
            </h2>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Sign in to your account to create short links, view analytics, and manage your link portfolio.
            </p>
          </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              ...
              >
                ...
                <div className="relative group">
                  <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-neutral-400"><Lock className="w-4 h-4" /></span>
                  <input
