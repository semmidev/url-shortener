          ...
          >
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              ...
              >
                ...
                <div className="relative group">
                  <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-muted-foreground"><Lock className="w-4 h-4" aria-hidden="true" /></span>
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full pl-10 pr-11 rounded-xl border bg-muted/50 hover:bg-muted/80 focus:bg-card px-3.5 py-2.5 text-sm text-foreground placeholder:text-muted-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary ${errors.password ? 'border-destructive' : 'border-border'}`}
                  />
                  <button
                    type="button"
              ...
              >
                {isSubmitting ? <><Loader2 className="w-4 h-4 animate-spin" aria-hidden="true" /> {t("auth.signingIn")}</> : t("auth.signInBtn")}
              </motion.button>
            </form>
            ...
            >
              ...
              {googleLoading ? <><Loader2 className="w-4 h-4 animate-spin" aria-hidden="true" /> {t("auth.signingIn")}</> : t("auth.googleSignIn")}
            </motion.button>
          </motion.div>
