  ...
  return (
    <div className="relative group">
      ...
      <input
        ...
        className={`w-full pl-9 pr-10 rounded-xl border bg-muted/50 hover:bg-muted/80 focus:bg-card px-3 py-2.5 text-sm text-foreground placeholder:text-muted-foreground outline-hidden transition-all focus:ring-2 focus:ring-primary/20 focus:border-primary ${error ? 'border-destructive' : 'border-border'}`}
      />
      <button
