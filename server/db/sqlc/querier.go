...
type Querier interface {
	...
	CountUserTenantsPaginated(ctx context.Context, arg CountUserTenantsPaginatedParams) (int64, error)
	...
	GetTenantByJoinCode(ctx context.Context, joinCode string) (GetTenantByJoinCodeRow, error)
	...
	GetTenantRoleByName(ctx context.Context, arg GetTenantRoleByNameParams) (GetTenantRoleByNameRow, error)
	...
	ListSystemRoles(ctx context.Context) ([]ListSystemRolesRow, error)
	ListTenantMembers(ctx context.Context, tenantID uuid.UUID) ([]ListTenantMembersRow, error)
	ListTenantRoles(ctx context.Context, tenantID *uuid.UUID) ([]ListTenantRolesRow, error)
	...
	ListUserTenantsPaginated(ctx context.Context, arg ListUserTenantsPaginatedParams) ([]ListUserTenantsPaginatedRow, error)
	...
	RegenerateTenantJoinCode(ctx context.Context, arg RegenerateTenantJoinCodeParams) (RegenerateTenantJoinCodeRow, error)
	...
	SoftDeleteTenantShortURLs(ctx context.Context, tenantID *uuid.UUID) error
